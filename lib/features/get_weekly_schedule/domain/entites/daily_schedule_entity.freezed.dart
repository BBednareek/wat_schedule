...
part of 'daily_schedule_entity.dart';
...
abstract mixin class $DayScheduleEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String date, List<EntryEntity> entries});
}
...
extension DayScheduleEntityPatterns on DayScheduleEntity {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String date, List<EntryEntity> entries)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _DayScheduleEntity implements DayScheduleEntity {
  _DayScheduleEntity(
      {required this.date, required final List<EntryEntity> entries})
      : _entries = entries;
