...
import 'package:wat_schedule/features/choose_department/presentation/widgets/department_grid/department_card.dart';
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return GridView.builder(
          ...
          itemCount: Departments.all.length,
          itemBuilder: (context, index) {
            final Department department = Departments.all[index];
